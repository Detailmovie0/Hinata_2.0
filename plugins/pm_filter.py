...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        ident, from_user = query.data.split("#")
        btn = [[
                InlineKeyboardButton("👀 Type Correct Spelling 🌿", callback_data=f"wsalert#{from_user}")
              ]]
        btn2 = [[
                 InlineKeyboardButton('ᴊᴏɪɴ ᴄʜᴀɴɴᴇʟ', url=link.invite_link),
                 InlineKeyboardButton("ᴠɪᴇᴡ ꜱᴛᴀᴛᴜꜱ", url=f"{query.message.link}")
        ...
        buttons = [[
		    ...
		    InlineKeyboardButton('〄 ⲘᎩ 𝐎ωner 〄', url="https://t.me/dvl_naruto_06"),
	        ],[
                    ...
                    InlineKeyboardButton('◖ Channel ◗', url='https://t.me/moviehub4u_update'),
                    InlineKeyboardButton('◖ Group ◗', url='https://t.me/movie_group_bot_0')
                ],[
                    InlineKeyboardButton('〇 ᴇᴀʀɴ ᴍᴏɴᴇʏ ᴡɪᴛʜ ʙᴏᴛ 〇', callback_data="earn")
                ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        try:
            btn = [[
                ...
                InlineKeyboardButton('𓁋 ʀᴇꜰᴇʀ ꜰʀɪᴇɴᴅꜱ 𓁋', callback_data='reffff'),
        ...
        try:
            btn = [[ 
                ...
                InlineKeyboardButton('𓇗 ᴜᴘɪ 𓇗', callback_data='upi')
            ],[
                InlineKeyboardButton('𓇬 ᴄʟᴏꜱᴇ 𓇬', callback_data='close_data')
            ]]
            reply_markup = InlineKeyboardMarkup(btn)
        ...
        buttons = [[
            InlineKeyboardButton ('sᴏᴜʀᴄᴇ owner', callback_data='source'),
        ],[
            InlineKeyboardButton('⇋ ʙᴀᴄᴋ ᴛᴏ ʜᴏᴍᴇ ⇋', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
            InlineKeyboardButton('ꜱᴏᴜʀᴄᴇ owner', url='https://t.me/dvl_naruto_06'),
...
async def advantage_spell_chok(client, message):
    ...
    buttons.append(
        [InlineKeyboardButton(text="𓇬 ᴄʟᴏsᴇ 𓇬", callback_data='close_data')]
    )
